  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1> Tìm kiếm<?php echo $_POST['searchdata'];?>"</h1>
      </div>
...
join tbltyperooms on tbltyperooms.id=tblrooms.RoomsTyperoom
where tblrooms.RoomsTitle=:search || tblrooms.ColorType=:search || tbltyperooms.TyperoomName=:search || tblrooms.NumberBed=:search";
...
<?php 
$sql = "SELECT tblrooms.*,tbltyperooms.TyperoomName,tbltyperooms.id as bid  from tblrooms 
join tbltyperooms on tbltyperooms.id=tblrooms.RoomsTpyeroom
where tblrooms.RoomsTitle=:search || tblrooms.ColorType=:search || tbltyperooms.TyperoomName=:search || tblrooms.NumberBed=:search";
$query = $dbh -> prepare($sql);
$query -> bindParam(':search',$searchdata, PDO::PARAM_STR);
$query->execute();
      ...
      <aside class="col-md-3 col-md-pull-9">
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-filter" aria-hidden="true"></i> Tìm Kiếm </h5>
          </div>
...
<option value="Tối">Tối</option>
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Tìm Kiếm</button>
              </div>
            </form>
          </div>
        </div>
        ...
        <div class="sidebar_widget">
          ...
          <div class="recent_addedcars">
            <ul>
<?php $sql = "SELECT tblrooms.*,tbltyperooms.TyperoomName,tbltyperooms.id as bid  from tblrooms join tbltyperooms on tbltyperooms.id=tblrooms.RoomsTpyeroomorder by id desc limit 4";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
