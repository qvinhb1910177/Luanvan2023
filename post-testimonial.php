...
<title>Hotel-QuangVinh |Đánh Giá</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Viết đánh giá</h5>
          ...
          <form  method="post">
            ...
            <div class="form-group">
              <button type="submit" name="submit" class="btn">Đăng  <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
