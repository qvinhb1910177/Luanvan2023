...
<title>Hotel-QuangVinh | Home</title>
<!--Bootstrap -->
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Tìm kiếm phòng tốt nhất<span>Cho bạn</span></h2>
      <p>Tìm & đặt phòng khách sạn giá rẻ chỉ với 3 bước đơn giản!
Khám phá ngay những ưu đãi tốt nhất dành cho bạn tại QuangVinh Hotel! </p>
    </div>
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Phòng Đẹp nhất cho bạn</a></li>
        </ul>
      </div>
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            ...
            <p>Kinh Doanh lĩnh vực khách sạn</p>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-xs-6 col-sm-3">
...
<section class="section-padding testimonial-section parallex-bg">
  <div class="container div_zindex">
    <div class="section-header white-text text-center">
      <h2>Đánh giá <span>của khách hàng</span></h2>
    </div>
    <div class="row">
