...
<head>
	...
	<title>Hotel-QuangVinh | Quản Lý Trang</title>
				...
				<div class="row">
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>Lỗi</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Trang</label>
												<div class="col-sm-8">
															   <select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
                  <option value="" selected="selected" class="form-control">***Trang***</option>
                  <option value="manage-pages.php?type=terms">Điều Khoản Dịch Vụ</option>
