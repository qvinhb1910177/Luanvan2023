...
$sql="update tblrooms set Vimage5=:vimage where id=:id";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Ảnh 5 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Chi Tiết Ảnh 5</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Ảnh 5</label>
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage5 from tblrooms where tblrooms.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
