    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo" > <a href="index.php"><img src="assets/images/logo.png" alt="image" style="height: 100px; width:150px;"/></a> </div>
        </div>
...
?>   
            ...
            <div class="header_widgets">
              ...
              <p class="uppercase_text">Liên hệ chúng tôi: </p>
...
echo "Chào mừng đến với khách sạn QuangVinh";
 } ?>
          </div>
        </div>
      </div>
...
foreach($results as $result)
   ...
   <i class="fa fa-angle-down" aria-hidden="true"></i></a>
           ...
           <?php if($_SESSION['login']){?>
            ...
            <li><a href="my-booking.php">Đơn đặt phòng</a></li>
            <li><a href="post-testimonial.php">Bình Luận</a></li>
          <li><a href="my-testimonials.php">Bình Luận của tôi</a></li>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="car-listing.php">Danh sách phòng</a>
          <li><a href="page.php?type=faqs">Chính sách bảo mật</a></li>
